        ...
        <div>
            <div className="text-center pt-28 px-20">
                ...
                <p className="text-md py-8 leading-8 md:text-xl max-w-2xl mx-auto text-gray-800 dark:text-gray-200">
                    I&apos;m a CS undergrad at SFU with an interest in full-stack development.<br />I love diving into new technologies to broaden my knowledge and develop new skills to overcome real-world challenges.
                </p>
